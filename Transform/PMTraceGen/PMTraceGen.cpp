...
//	init();
	...
	//outs()<<"Beginning Init function\n";
        ...
        //outs()<<"Added pmc_initialize\n";
	// Now insert a call to this function at the beginning of the function 'F'
//    	llvm::BasicBlock &entryBlock = F.getEntryBlock();  // Get the first basic block
  //  	llvm::IRBuilder<> builder(&entryBlock, entryBlock.begin());  // Set the insertion point at the beginning

    	// Create the call to __pmc_Initialize
    //	builder.CreateCall(__pmc_Initialize);
