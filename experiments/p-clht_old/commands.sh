...
clang-10 -g -O3 -c external/sspfd/sspfd.c -o sspfd.o

clang-10 -g -O3 -c -I external/ssmem/include external/ssmem/src/ssmem.c -o ssmem.o

clang++-10 -g -O3 example_trace.bc clht_gc_trace.bc clht_lb_res_trace.bc sspfd.o ssmem.o -o example_executable -lboost_system -lboost_thread -ltbb -ljemalloc -lpthread -I../../../PMBugRepair/build/Transform/../../Transform/PM -L../../../PMBugRepair/build/Transform/PM  -Wl,-rpath=../../../PMBugRepair/build/Transform/PM -lLLVMPMC  -O0 -lpmemobj -lpmem
