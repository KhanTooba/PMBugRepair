 ...
 */
__attribute__((used)) void stack_conf_init(StackConf *conf)
{
 ...
 */
__attribute__((used)) enum  cc_stat stack_new(Stack **out)
{
    StackConf conf;
 ...
 */
__attribute__((used)) enum  cc_stat stack_new_conf(StackConf const * const conf, Stack **out)
{
    ...
    stack->mem_alloc  = pmalloc;
    stack->mem_calloc = pcalloc;
    stack->mem_free   = pfree;
 ...
 */
__attribute__((used)) void stack_destroy(Stack *stack)
{
 ...
 * @param[in] stack the stack to be destroyed
 */
__attribute__((used)) void stack_destroy_cb(Stack *stack, void (*cb) (void*))
{
 ...
 */
__attribute__((used)) enum  cc_stat stack_push(Stack *stack, void *element)
{
 ...
 * Stack is empty.
 */
__attribute__((used)) enum  cc_stat stack_peek(Stack *stack, void **out)
{
 ...
 */
__attribute__((used)) enum  cc_stat stack_pop(Stack *stack, void **out)
{
 ...
 */
__attribute__((used)) size_t stack_size(Stack *stack)
{
 ...
 */
__attribute__((used)) void stack_map(Stack *stack, void (*fn) (void *))
{
...
__attribute__((used)) enum  cc_stat stack_filter_mut(Stack *stack, bool (*predicate)(const void *))
{
...
__attribute__((used)) enum  cc_stat stack_filter(Stack *stack, bool (*predicate)(const void *), Stack **out)
{
 ...
 */
__attribute__((used)) void stack_iter_init(StackIter *iter, Stack *s)
{
 ...
 */
__attribute__((used)) enum  cc_stat stack_iter_next(StackIter *iter, void **out)
{
 ...
 * CC_ERR_OUT_OF_RANGE.
 */
__attribute__((used)) enum  cc_stat stack_iter_replace(StackIter *iter, void *element, void **out)
{
 ...
 */
__attribute__((used)) void stack_zip_iter_init(StackZipIter *iter, Stack *s1, Stack *s2)
{
 ...
 */
__attribute__((used)) enum  cc_stat stack_zip_iter_next(StackZipIter *iter, void **out1, void **out2)
{
 ...
 */
__attribute__((used)) enum  cc_stat stack_zip_iter_replace(StackZipIter *iter, void *e1, void *e2, void **out1, void **out2)
{
